...
- (void)setHeaderImage:(UIImage *)image text:(NSString *)text like:(NSString*)like wish:(NSString*)wish{
...
- (UIImageView *)headerImageView {
    if (!_headerImageView) {
        ...
        _headerImageView.center = CGPointMake(kSelfWidth / 2, kSelfHeight / 2 - 40);
...
- (UILabel *)label {
    if (!_label) {
        ...
        _label.centerY = kSelfWidth / 2 - 40;
...
-(UILabel *)likeLabel {
    ...
    if (!_likeLabel) {
        ...
        _likeLabel.size = CGSizeMake(kSelfWidth, 20);
        _likeLabel.centerX = kSelfWidth / 2 - 70;
        _likeLabel.centerY = kSelfWidth / 2 + 20;
        _likeLabel.top = self.label.bottom + 35;
...
-(UILabel *)wishLabel {
    ...
    if (!_wishLabel) {
        ...
        _wishLabel = [[UILabel alloc] init];
        _wishLabel.backgroundColor = [UIColor clearColor];
        _wishLabel.textColor = [UIColor whiteColor];
        _wishLabel.font = [UIFont systemFontOfSize:14];
        _wishLabel.textAlignment = 1;
        _wishLabel.size = CGSizeMake(kSelfWidth, 20);
        _wishLabel.centerX = kSelfWidth / 2 + 70;
        _wishLabel.centerY = kSelfWidth / 2 + 20;
        _wishLabel.top = self.label.bottom + 35;
        [self addSubview:_wishLabel];
    }
