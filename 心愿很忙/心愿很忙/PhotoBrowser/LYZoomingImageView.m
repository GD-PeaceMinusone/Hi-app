...
- (void)setPhoto:(LYPhoto *)photo{
    ...
    [self.zoomImageView sd_setImageWithURL:[NSURL URLWithString:_photo.photoUrl] placeholderImage:tempImage options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize,NSURL * _Nullable targetURL) {
